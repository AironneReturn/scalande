class Week {
  ...
  DateTime day(int day) {
    final d =
        DateTime(year ?? 2000, 1, 4); // The Jan 4th must be in week 1 according to ISO
    return d.add(Duration(days: ((weekNumber ?? 01) - 1) * 7 + (-d.weekday + day) + 1));
  }
